...
const translations = {
  fr: {
    ...
    help_how_3: "Apres validation, le pass devient actif pendant 90 jours.",
    ...
    help_page_passes: "Passes", help_page_passes_text: "Choisissez un pass selon votre budget. Achetez-le via Mobile Money, GeniusPay ou virement. Apres validation, le pass est actif 90 jours et genere un revenu quotidien.",
  ...
  en: {
    ...
    help_how_3: "After validation, the pass stays active for 90 days.",
    ...
    help_page_passes: "Passes", help_page_passes_text: "Choose a pass based on your budget. Buy it via Mobile Money, GeniusPay or bank transfer. After validation, the pass is active for 90 days and generates daily revenue.",
