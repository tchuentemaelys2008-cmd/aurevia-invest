              ...
              <div className="flex items-center justify-between px-6 py-4 border-b border-white/8">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-xl bg-[#e23744]/20 flex items-center justify-center">
                    <Trophy size={15} className="text-[#e23744]" />
                  </div>
                  <div>
              ...
              {missions.map(m => (
                <tr key={m.id} className="hover:bg-white/2 transition-colors">
                  ...
                  <td className="px-4 py-3">
                    <span className="text-xs bg-[#e23744]/10 text-[#e23744] px-2 py-0.5 rounded-full capitalize">{m.type}</span>
                  </td>
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center justify-center gap-2">
                      <button onClick={() => openEdit(m)} className="w-7 h-7 flex items-center justify-center rounded-lg text-white/30 hover:text-[#e23744] hover:bg-[#e23744]/10 transition-all">
                        <Pencil size={13} />
                      </button>
