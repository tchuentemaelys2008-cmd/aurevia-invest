      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 bg-[#3b6fd4]/20 rounded-xl flex items-center justify-center">
            <Gift size={18} className="text-[#3b6fd4]" />
          </div>
          <div>
              ...
              <div className="flex items-center justify-between px-6 py-4 border-b border-white/8">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-xl bg-[#3b6fd4]/20 flex items-center justify-center">
                    <Sparkles size={15} className="text-[#3b6fd4]" />
                  </div>
                  <div>
            ...
            <div key={g.id} className="bg-[#0c1428] border border-white/10 rounded-2xl p-4">
              <div className="flex items-start justify-between gap-3 flex-wrap">
                <div className="min-w-0">
                  ...
                  <p className="text-[#3b6fd4] font-display font-bold mt-1">{g.value.toLocaleString()} FCFA</p>
                </div>
              ...
              <div className="mt-3 flex items-center gap-2 rounded-xl bg-white/4 border border-white/8 px-3 py-2">
                ...
                <button onClick={() => copyLink(g.code)} className="flex items-center gap-1.5 text-xs font-semibold text-[#3b6fd4] hover:opacity-80 whitespace-nowrap">
