...
import { Trophy, RotateCcw, ShieldCheck } from "lucide-react";
import toast from "react-hot-toast";

interface Entry { id: string; name: string; email: string; totalInvested: number; totalEarnings: number; level: number; isVerified: boolean; rank: number; }
...
export default function AdminLeaderboardPage() {
  ...
  const reset = async () => {
    ...
    toast.success("Classement réinitialisé"); load();
  };
