...
export default function OpengraphImage() {
  return new ImageResponse(
    (
      ...
      >
        {/* Ambient glows */}
        <div style={{ position: "absolute", top: -160, left: 360, width: 520, height: 520, borderRadius: 520, background: "rgba(59,111,212,0.35)", filter: "blur(60px)" }} />
        <div style={{ position: "absolute", bottom: -180, right: 280, width: 460, height: 460, borderRadius: 460, background: "rgba(108,77,230,0.30)", filter: "blur(60px)" }} />
        ...
        <div
          style={{
            ...
            height: 150,
            borderRadius: 38,
            background: "linear-gradient(135deg,#3b6fd4,#6c4de6)",
            fontSize: 96,
            fontWeight: 800,
            boxShadow: "0 20px 60px rgba(59,111,212,0.5)",
          }}
        >
          A
        </div>
