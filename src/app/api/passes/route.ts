...
const defaultPasses = [
  { id: "aurevia-starter", name: "Aurevia Starter", price: 4000, dailyReturn: 10, duration: 120, color: "#e23744", icon: "shield", description: "Ideal pour demarrer avec un revenu clair et simple." },
  { id: "aurevia-mini", name: "Aurevia Mini", price: 5000, dailyReturn: 10, duration: 120, color: "#e23744", icon: "zap", description: "Un petit depot pour tester Aurevia et lancer vos revenus." },
  ...
  { id: "aurevia-plus", name: "Aurevia Plus", price: 15000, dailyReturn: 10, duration: 120, color: "#b51d2c", icon: "star", description: "Un palier equilibre entre depot et revenu." },
  { id: "aurevia-silver", name: "Aurevia Silver", price: 25000, dailyReturn: 10, duration: 120, color: "#b51d2c", icon: "star", description: "Acces Silver avec meilleur suivi et priorite de support." },
