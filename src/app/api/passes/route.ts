...
const defaultPasses = [
  { id: "aurevia-starter", name: "Aurevia Starter", price: 4000, dailyReturn: 10, duration: 120, color: "#5b6ef5", icon: "shield", description: "Ideal pour demarrer avec un revenu clair et simple." },
  { id: "aurevia-mini", name: "Aurevia Mini", price: 5000, dailyReturn: 10, duration: 120, color: "#5b6ef5", icon: "zap", description: "Un petit depot pour tester Aurevia et lancer vos revenus." },
  ...
  { id: "aurevia-plus", name: "Aurevia Plus", price: 15000, dailyReturn: 10, duration: 120, color: "#6c5ce7", icon: "star", description: "Un palier equilibre entre depot et revenu." },
  { id: "aurevia-silver", name: "Aurevia Silver", price: 25000, dailyReturn: 10, duration: 120, color: "#6c5ce7", icon: "star", description: "Acces Silver avec meilleur suivi et priorite de support." },
