...
const defaultPasses = [
  ...
  { id: "aurevia-plus", name: "Aurevia Plus", price: 15000, dailyReturn: 10, duration: 120, color: "#2d5bcc", icon: "star", description: "Un palier equilibre entre depot et revenu." },
  { id: "aurevia-silver", name: "Aurevia Silver", price: 25000, dailyReturn: 10, duration: 120, color: "#2d5bcc", icon: "star", description: "Acces Silver avec meilleur suivi et priorite de support." },
