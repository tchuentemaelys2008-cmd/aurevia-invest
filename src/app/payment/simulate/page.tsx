      ...
      <div className="w-full max-w-sm">
        <div className="glass-card rounded-2xl p-6 text-center">
          ...
          <div className="flex items-center justify-center gap-2 mb-6">
            {method === "fapshi" ? <Smartphone size={20} className="text-[#e23744]" /> : <CreditCard size={20} className="text-[#e23744]" />}
          ...
          {status === "pending" && (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-[#e23744]/15 border-2 border-[#e23744]/30 flex items-center justify-center">
                <Clock size={28} className="text-[#e23744]" />
              </div>
          ...
          {status === "processing" && (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              <div className="w-16 h-16 mx-auto mb-4 rounded-full border-2 border-[#e23744] border-t-transparent animate-spin" />
