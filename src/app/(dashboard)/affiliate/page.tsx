  ...
  return (
    <div className="max-w-xl mx-auto px-4 pt-8 pb-24">
      ...
      <motion.div initial="hidden" animate="show" custom={0} variants={fadeUp} className="mb-6">
        <p className="text-[#3b6fd4] text-xs font-semibold uppercase tracking-widest mb-1">{t("affiliate_kicker")}</p>
      ...
      <motion.div initial="hidden" animate="show" custom={1} variants={fadeUp} className="mb-5">
        <div className="relative rounded-2xl overflow-hidden p-5" style={{ background: "linear-gradient(135deg, rgba(59,111,212,0.15), rgba(108,77,230,0.12))", border: "1px solid rgba(59,111,212,0.2)" }}>
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#3b6fd4] to-[#6c4de6] flex items-center justify-center flex-shrink-0 shadow-lg shadow-[#3b6fd4]/30">
            ...
            <div>
              ...
              <div className="flex items-center gap-1.5 mt-1.5">
                <Zap size={12} className="text-[#3b6fd4]" />
                <span className="text-xs text-[#3b6fd4] font-semibold">{lang === "fr" ? "Crédité instantanément" : "Instantly credited"}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <motion.div initial="hidden" animate="show" custom={3} variants={fadeUp} className="mb-5">
        <Card>
          ...
          <div className="flex items-center gap-2 p-3 rounded-xl mb-3" style={{ background: "var(--control-bg)", border: "1px solid var(--control-border)" }}>
            ...
            <button type="button" onClick={copyLink} className="flex-shrink-0 w-8 h-8 rounded-lg bg-[#3b6fd4]/20 flex items-center justify-center text-[#3b6fd4] hover:bg-[#3b6fd4]/30 transition-colors touch-manipulation">
              <Copy size={14} />
            </button>
          </div>
