  ...
  return (
    <div className="p-4 lg:p-8 max-w-lg mx-auto">
      <div className="mb-8 text-center">
        <p className="text-xs font-semibold text-[#2d5bcc] uppercase tracking-widest mb-1">{t("spin_kicker")}</p>
      ...
      <div className="glass-card rounded-3xl p-8 flex flex-col items-center gap-8">
        ...
        {state?.canSpin ? (
          <button onClick={spin} disabled={spinning}
            className="w-full py-4 bg-gradient-to-r from-[#2d5bcc] to-[#3b6fd4] text-white font-bold rounded-2xl text-lg hover:opacity-90 transition-all disabled:opacity-50 flex items-center justify-center gap-3">
            <Sparkles size={20} />
