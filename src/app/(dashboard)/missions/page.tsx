...
export default function MissionsPage() {
  ...
  return (
    <div className="p-4 lg:p-8 max-w-2xl mx-auto">
      <div className="mb-8">
        <p className="text-xs font-semibold text-[#3b6fd4] uppercase tracking-widest mb-1">{t("missions_kicker")}</p>
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      <span className="text-[10px] font-semibold text-[#3b6fd4] bg-[#3b6fd4]/10 px-2 py-0.5 rounded-full">{typeLabel(m.type)}</span>
                    ...
                    <div className="mt-3">
                      ...
                      <div className="h-1.5 bg-white/5 rounded-full overflow-hidden">
                        <div className="h-full bg-gradient-to-r from-[#3b6fd4] to-[#2d5bcc] rounded-full transition-all duration-500" style={{ width: `${pct}%` }} />
                      </div>
                    </div>
                  </div>
                  <div className="flex flex-col items-end gap-2 flex-shrink-0">
                    ...
                    {completed ? (
                      ...
                      <button onClick={() => claim(m.id)} disabled={claiming === m.id}
                        className="text-xs font-semibold bg-gradient-to-r from-[#3b6fd4] to-[#2d5bcc] text-white px-3 py-1.5 rounded-xl hover:opacity-90 transition-all disabled:opacity-50">
