                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="mt-3">
                      ...
                      <div className="h-1.5 bg-white/5 rounded-full overflow-hidden">
                        <div className="h-full bg-gradient-to-r from-[#3b6fd4] to-[#6c4de6] rounded-full transition-all duration-500" style={{ width: `${pct}%` }} />
                      </div>
                    </div>
                  </div>
                  <div className="flex flex-col items-end gap-2 flex-shrink-0">
                    ...
                    {completed ? (
                      ...
                      <button onClick={() => claim(m.id)} disabled={claiming === m.id}
                        className="text-xs font-semibold bg-gradient-to-r from-[#3b6fd4] to-[#6c4de6] text-white px-3 py-1.5 rounded-xl hover:opacity-90 transition-all disabled:opacity-50">
