  ...
  return (
    <div className="max-w-xl mx-auto px-4 pt-8 pb-6">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="mb-5">
        <div className="relative rounded-2xl overflow-hidden border border-[#3b6fd4]/20 bg-gradient-to-br from-[#3b6fd4]/15 to-[#2d5bcc]/10 p-6">
          <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#3b6fd4] to-[#2d5bcc] flex items-center justify-center mb-4">
