...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "primary", size = "md", loading, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      primary: "bg-gradient-to-r from-[#3b6fd4] to-[#2d5bcc] text-white shadow-[0_4px_20px_rgba(226,55,68,0.35)] hover:shadow-[0_8px_32px_rgba(226,55,68,0.55)] hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.97] active:shadow-[0_2px_10px_rgba(226,55,68,0.3)]",
