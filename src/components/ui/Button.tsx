...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "primary", size = "md", loading, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      primary: "bg-gradient-to-r from-[#5b6ef5] to-[#6c5ce7] text-white shadow-[0_4px_20px_rgba(91,110,245,0.35)] hover:shadow-[0_8px_32px_rgba(91,110,245,0.55)] hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.97] active:shadow-[0_2px_10px_rgba(91,110,245,0.3)]",
