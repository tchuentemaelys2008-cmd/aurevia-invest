...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "primary", size = "md", loading, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      primary: "bg-gradient-to-r from-[#3b6fd4] to-[#6c4de6] text-white shadow-[0_4px_20px_rgba(59,111,212,0.4)] hover:shadow-[0_6px_30px_rgba(59,111,212,0.5)] hover:-translate-y-px active:translate-y-0",
      secondary: "bg-white/6 border border-white/10 text-white hover:bg-white/10 hover:border-white/15",
