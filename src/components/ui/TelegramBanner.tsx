    ...
    <section className="px-4 pt-4">
      <div className="relative mx-auto max-w-4xl overflow-hidden rounded-3xl border border-[var(--control-border)] bg-[var(--surface-card)] p-4 shadow-[0_12px_40px_rgba(0,0,0,0.3)] shine-card sm:p-5">
        ...
        <div className="relative mb-4 text-center">
          <p
            className="bg-gradient-to-r from-[#3b6fd4] via-[#7d8ff0] to-[#6c4de6] bg-clip-text text-3xl font-display font-extrabold text-transparent sm:text-4xl"
          ...
          <div className="banner-track flex gap-3">
            {loop.map((src, index) => (
              ...
              >
                ...
                {/* Sheen on hover */}
                <div className="pointer-events-none absolute inset-0 opacity-0 transition-opacity duration-500 group-hover:opacity-100 bg-gradient-to-tr from-[#3b6fd4]/20 via-transparent to-transparent" />
              </div>
            ))}
          </div>
        </div>
