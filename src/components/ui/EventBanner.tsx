...
export default function EventBanner() {
  ...
  const typeColor: Record<string, string> = { double_earnings: "#10b981", discount: "#f59e0b", bonus: "#6c5ce7", xp_boost: "#5b6ef5" };
  const color = event ? (typeColor[event.type] || "#5b6ef5") : "#5b6ef5";
